        ...
        <div className=' bg-[#77153db2] pb-2'>
            <div className='md:w-5/6 mx-auto grid md:grid-cols-3 md:py-20 py-5 px-3'>
                <div className='md:border-e-2 text-white mb-3 md:mb-0'>
                    ...
                    <input className='rounded p-3' type="text" placeholder='Enter Your Email' /> <button className=' bg-[#470d25b2] rounded-lg px-2 py-3 text-white hover:text-white border-none'>Sign up</button>
                </div>
                ...
                <div className=' text-white md:px-20'>
                    ...
                    <p>ehero@admission.com</p>
                    <p className='my-2'>666 888 0000</p>
                </div>
            </div>
            <p className='text-center text-white p-2 -mt-5'><small>All rights reserved 3NST softwer company</small></p>
        </div>
    );
};
