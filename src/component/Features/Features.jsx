    ...
    return(
        <div className="bg-[#eaeaeb] container mx-auto rounded-md mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 mt-5">
                <div className="bg-white border-b-[#77153db2]  features border-2 rounded p-8 m-8 text-center  border-gray-300 card relative hover:shadow-lg transform hover:scale-105 transition-transform duration-300">
